...
const MobilePageSelector: React.FC<MobilePageSelectorProps> = ({ changePage, currentPage }) => {
    ...
    return (
        <div style={selectorStyle}>
            <div style={buttonsContainerStyle}>
                <div
                    style={currentPage === 'landing' ? activeButtonStyle : buttonStyle}
                    onClick={() => changePage('landing')}
                >
                    ABOUT
                </div>
                <div
                    style={currentPage === 'projects' ? activeButtonStyle : buttonStyle}
...
export default MobilePageSelector;
